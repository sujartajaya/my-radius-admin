        ...
        <div class="max-w w-full">
            <div class="flex flex-col items-center justify-center px-3 py-8 mx-auto lg:py-0 mt-1">
                <div class="w-full max-w-4xl bg-white rounded-lg shadow-md p-6">
                    ...
                    <h2 class="text-xl font-semibold text-gray-800">Guest User Group</h2>
                    ...
                    <table class="w-full border-collapse border border-gray-200">
                        ...
                        <tr class="bg-gray-100">
                            ...
                            <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-600">Group Name</th>
                            <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-600">Actions</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php $i=$data->firstItem(); $dt = 0; ?>
                        @foreach ($data as $group)
                        <tr>
                            <?php $dt=$dt+1; ?>
                            <td class="border border-gray-300 px-4 py-2 text-sm text-gray-700">{{ $i++ }}</td>
                            <td class="border border-gray-300 px-4 py-2 text-sm text-gray-700">{{ $group->groupname }}</td>
                            <td class="border border-gray-300 px-4 py-2 text-sm text-gray-700">
                            <div class="flex space-x-2">
                                <button
                                class="bg-green-500 text-white px-3 py-1 rounded hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400" onClick="edit({{ $group->groupname }})"
                                >
                                Edit
                                </button>
                                <button
